...
let map_ = new Map([['1', 'str1'], [1, 'num1'], [true, 'bool1']]);
...
// map.entries() – возвращает итерируемый объект для записей [ключ, значение],
// он используется по умолчанию в for..of. Перебор идёт в том же порядке, что и
// вставка.
let recipeMap = new Map([['огурцов', '500 гр'], ['помидоров', '350 гр'],
  ['сметаны', '50 гр']]);
