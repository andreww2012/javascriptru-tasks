...
// Записываю для себя. Полная статья: http://learn.javascript.ru/es-function
...
// Этот же оператор можно использовать и при вызове функции, для передачи массива параметров
// как списка.
...
// Если хочется, чтобы функция могла быть вызвана вообще без аргументов – нужно добавить ей
// параметр по умолчанию – уже не внутрь деструктуризации, а в самом списке аргументов.
...
// В свойстве name у функции находится её имя. Теперь при создании анонимной функции с
// одновременной записью в переменную или свойство – её имя равно названию переменной (или свойства)
