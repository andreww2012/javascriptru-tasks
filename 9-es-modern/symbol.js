...
// Записываю для себя. Полная статья: http://learn.javascript.ru/symbol
...
// У функции Symbol есть необязательный аргумент «имя символа». Его можно использовать для описания
// символа в целях отладки. Каждый символ сам по себе уникален.
let sym2 = Symbol("name");
alert(sym2.toString()); // Symbol(name)
alert(Symbol("name") == Symbol("name")); // false

// Глобальные символы можно получать из глобального реестра по имени (и добавлять туда)
...
// Symbol.toPrimitive – идентификатор для свойства, задающего функцию преобразования объекта в
// примитив.
// Symbol.iterator – идентификатор для свойства, задающего функцию итерации по объекту.

// Получение всех символов объекта: Object.getOwnPropertySymbols.
